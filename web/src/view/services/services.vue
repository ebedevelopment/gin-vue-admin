  ...
  <div>
    ...
    >
      <el-form :model="formData" label-position="left" label-width="20%">
        ...
        <el-form-item label="frontends:">
          <el-select
            multiple
            v-model="formData.frontend"
            clearable
            placeholder="please enter"
            style="width: 100%"
          >
...
import { getFrontendsList } from "@/api/frontends";
...
const getFrontendData = async () => {
  ...
  if (table.code === 0) {
    frontendData.value = table.data.list;
  }
};
