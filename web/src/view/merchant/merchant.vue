<template>
  <div>
    ...
    <div class="gva-table-box">
        ...
        <el-table-column align="left" label="createBy field" prop="createBy" width="120" />
        ...
        <el-table-column align="left" label="updateBy field" prop="updateBy" width="120" />
        <el-table-column align="left" label="userName field" prop="userName" width="120" />
        <el-table-column align="left" :label="t('')">
            <template #default="scope">
            <el-button type="text" icon="edit" size="small" class="table-button" @click="updateMerchantFunc(scope.row)">{{ t('edit') }}</el-button>
    ...
    <el-dialog v-model="dialogFormVisible" :before-close="closeDialog" :title="t('Create')">
      <el-form :model="formData" label-position="right" label-width="80px">
        ...
        <el-form-item label="lastLogin field:">
          <el-date-picker v-model="formData.lastLogin" type="date" style="width:100%" placeholder="select date" clearable />
        </el-form-item>
