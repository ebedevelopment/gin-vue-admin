  ...
  <div class="init_page">
    <div class="init_page_panle">
      ...
      <div
        ...
        class="form"
      >
        <el-form ref="formRef" :model="form" label-width="20%">
          ...
          <el-form-item :label="t('init.language')">
            ...
            >
              ...
              <el-option key="zh" label="中文" value="zh"
                ><img src="@/assets/flags/zh.svg" class="img" />中文</el-option
              >
              <el-option key="ar" label="العربية" value="ar"
                ><img
