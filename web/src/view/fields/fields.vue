<template>
  <div>
    ...
    <div class="gva-table-box">
        ...
        <el-table-column align="left" label="doubleCheck " prop="doubleCheck" width="120" />
        <el-table-column align="left" label="max " prop="max" width="120" />
        <el-table-column align="left" label="min " prop="min" width="120" />
        ...
        <el-table-column align="left" label="regex " prop="regex" width="120" />
        <el-table-column align="left" label="required " prop="required" width="120">
            <template #default="scope">{{ formatBoolean(scope.row.required) }}</template>
        </el-table-column>
        <el-table-column align="left" label="typeId " prop="typeId" width="120" />
